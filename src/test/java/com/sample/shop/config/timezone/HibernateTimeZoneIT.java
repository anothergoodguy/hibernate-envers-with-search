package com.sample.shop.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.sample.shop.IntegrationTest;
import com.sample.shop.repository.timezone.DateTimeWrapper;
import com.sample.shop.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM tm_date_time_wrapper where id=%d", fieldName, id);
    }
