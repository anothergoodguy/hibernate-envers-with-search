...
public class AddressVersion {
    ...
    public AddressVersion(Number revision, RevisionType revisionType, UUID revisedBy, String revisedByType, String auditor) {
        ...
        this.mEntityId = new AuditIdentity(new CustomEntityId(addressDTO.getId()), revision.intValue());
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            addressDTO.equals(that.addressDTO) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mEntityId, addressDTO, revision, revisionType, revisedBy, revisedByType, auditor);
    }
