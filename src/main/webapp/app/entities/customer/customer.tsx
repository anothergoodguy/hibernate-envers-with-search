...
import { searchEntities, getEntities, reset } from './customer.reducer';
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('storeApp.customer.home.search')}
                />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('telephone')}>
                    <Translate contentKey="storeApp.customer.telephone">Telephone</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
