...
import { searchEntities, getEntities, reset } from './wish-list.reducer';
...
export const WishList = () => {
  ...
  const links = useAppSelector(state => state.wishList.links);
  const entity = useAppSelector(state => state.wishList.entity);
  ...
  return (
    <div>
      <h2 id="wish-list-heading" data-cy="WishListHeading">
        <Translate contentKey="storeApp.wishList.home.title">Wish Lists</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="storeApp.wishList.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/wish-list/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.wishList.home.createLabel">Create new Wish List</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('storeApp.wishList.home.search')}
                />
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={wishListList ? wishListList.length : 0}
          next={handleLoadMore}
          ...
          {wishListList && wishListList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="storeApp.wishList.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="storeApp.wishList.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('restricted')}>
                    <Translate contentKey="storeApp.wishList.restricted">Restricted</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="storeApp.wishList.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="storeApp.wishList.home.notFound">No Wish Lists found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
