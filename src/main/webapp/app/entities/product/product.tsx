            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('storeApp.product.home.search')}
                />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="storeApp.product.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('keywords')}>
                    <Translate contentKey="storeApp.product.keywords">Keywords</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={sort('rating')}>
                    <Translate contentKey="storeApp.product.rating">Rating</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('dateAdded')}>
                    <Translate contentKey="storeApp.product.dateAdded">Date Added</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('dateModified')}>
                    <Translate contentKey="storeApp.product.dateModified">Date Modified</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="storeApp.product.wishList">Wish List</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
